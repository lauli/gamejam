...
class TasksViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.hide(_1: false, _2: true, _3: true, _4: true)
        self.setup()
    }
    ...
    // MARK: Custom Methods
    private func hide(_1 first: Bool, _2 second: Bool, _3 third: Bool, _4 fourth: Bool) {
    ...
    @IBAction func switchedTabTo(_ sender: UISegmentedControl) {
        ...
        case 0:
            ...
            break
        case 1:
            self.hide(_1: true, _2: false, _3: true, _4: true)
            break
        case 2:
            self.hide(_1: true, _2: true, _3: false, _4: true)
            break
        case 3:
            self.hide(_1: true, _2: true, _3: true, _4: false)
            break
        case 4:
            self.hide(_1: true, _2: true, _3: true, _4: true)
            break
        default:
            self.hide(_1: false, _2: true, _3: true, _4: true)
            break
